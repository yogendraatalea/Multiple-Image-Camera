...
class _CameraFileState extends State<CameraFile> with TickerProviderStateMixin {
 ...
 if (imageFiles.isNotEmpty) {
        int lastIndex = imageFiles.length - 1;
        String lastImagePath = imageFiles[lastIndex].path;
        print("The path of the last image: $lastImagePath");
      } else {
 ...
 String lastImagePath = "";
  if (imageFiles.isNotEmpty) {
    int lastIndex = imageFiles.length - 1;
    lastImagePath = imageFiles[lastIndex].path;
  }
    if (_controller != null) {
